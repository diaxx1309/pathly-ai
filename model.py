...
if __name__ == "__main__":
    ...
    X_train, X_test, y_exam_train, y_exam_test = train_test_split(X, y_exam, test_size=0.2, random_state=42)
    _, _, y_col_train, y_col_test = train_test_split(X, y_college, test_size=0.2, random_state=42)
    ...
    print("=== EXAM MODEL ===")
    print(classification_report(y_exam_test, exam_model.predict(X_test)))

    print("=== COLLEGE MODEL ===")
    print(classification_report(y_col_test, college_model.predict(X_test)))